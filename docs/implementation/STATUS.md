...
| Tests Swift / XCUITest G0 et G1A | iPhone : 43/43 ; iPad : 2/2 | Run `36020145724` réussi ; le parcours G0 avec historique et bilan après relance passe sur les deux appareils |
...
| Configuration/activation G1B | Implémentée ; déploiement et validation Apple en cours | 57 tests serveur réussis sur PostgreSQL 16.14 et 17.11 ; commandes chiffrées sur le client ; aucune politique ou activation approuvée automatiquement |
...
Le [run G1A `36017673076`](https://github.com/tomyrms/Drivy/actions/runs/36017673076) réussit 41 tests Swift (12 Core, 11 Identity, 8 API, 10 Workspace) et le test de présentation iPhone. L'XCUITest échouait à ouvrir la séance persistée depuis l'historique ; le chemin de navigation est désormais porté explicitement par la racine. Le [run suivant `36020145724`](https://github.com/tomyrms/Drivy/actions/runs/36020145724), commit `30999d6`, est entièrement réussi : **43/43 tests iPhone, 2/2 iPad**, IPA compris. Les captures et résumés téléchargés confirment le parcours G0 après relance. Leur revue a identifié un contraste de sélection iPad et un bandeau de laboratoire masquant la navigation ; leurs corrections accompagnent G1B et attendent ses captures Apple.
