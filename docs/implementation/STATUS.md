...
| Connexion scolaire depuis un client | G1A en implémentation native | Connexion AppAuth/PKCE, choix d'école, élèves et formations ; qualification Apple en préparation, hébergement existant choisi par le porteur, accès attendus |
