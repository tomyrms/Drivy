...
**Mise à jour du 25 septembre 2026 :** `permitWarning` est désormais calculé depuis le contrôle de permis ([g2-permis.md](g2-permis.md)) ; l’annulation ouvre un compte de leçon sans charge ; l’absence AP44 et la correction AP50 sont décrites dans [g2-issues-lecon.md](g2-issues-lecon.md). Les parcours HTTP de cette tranche sont couverts par [tests-planning-bilan.md](tests-planning-bilan.md).
